...
/*   Updated: 2019/12/16 20:11:44 by sschmele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		printf_readline_help_further(void)
{
	...
	ft_printf("%s'Esc + r' - Undo all changes made to this ", space);
	ft_printf("line or clear the line\n");
